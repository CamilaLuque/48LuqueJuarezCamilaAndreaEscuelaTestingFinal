...
## 3. Features desarrollados
*   **Store:** El proyecto está configurado para usar Java 17.
*   **User:** Se utiliza para la gestión de dependencias y la ejecución de las pruebas.
